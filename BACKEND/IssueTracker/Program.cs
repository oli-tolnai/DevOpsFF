        ...
        public static void Main(string[] args)
        {
            ...
            }).AddJwtBearer(options =>
            {
                ...
                options.TokenValidationParameters = new TokenValidationParameters()
                {
                    ...
                    IssuerSigningKey = new SymmetricSecurityKey(Encoding.UTF8.GetBytes("Hossz�titkos�t�kulcsHossz�titkos�t�kulcsHossz�titkos�t�kulcsHossz�titkos�t�kulcsHossz�titkos�t�kulcsHossz�titkos�t�kulcsHossz�titkos�t�kulcsHossz�titkos�t�kulcsHossz�titkos�t�kulcs"))
                };
            }); ;
